    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <footer className="bg-white py-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a href="https://www.linkedin.com/in/abdulanasbuilds" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-sm font-medium">
